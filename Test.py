...
section[data-testid="stSidebar"] > div:first-child {padding-top: -0.2rem !important;}
</style>
...
def main():
    ...
    if st.session_state['page'] == 'welcome':
        ...
        st.markdown("<h2 style='margin:0; padding:0; text-align:left;'>🏫 SCIS Campus Navigation System</h4>", unsafe_allow_html=True)
